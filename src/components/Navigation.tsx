...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-sm shadow-lg z-50 border-b-4 border-yellow-400">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <span className="font-bold text-xl text-purple-600 hidden sm:block">
              Magical Stories
            </span>
          </Link>
