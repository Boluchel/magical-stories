      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center">
          <div className={`backdrop-blur-sm rounded-3xl p-12 border-2 shadow-lg transition-colors duration-300 ${
            ...
            <Link
              to="/create"
              className="inline-block bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold py-4 px-2 md:px-12 rounded-full text-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
            >
