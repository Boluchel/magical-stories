        ...
        <form onSubmit={handleSubmit} className={`backdrop-blur-sm rounded-3xl p-8 border-2 shadow-lg transition-colors duration-300 ${
          ...
          <div className="text-center">
            <button
              ...
              className="magic-button disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 px-12 rounded-full text-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 glow"
            >
              🌟 Create My Story! 🌟
            </button>
