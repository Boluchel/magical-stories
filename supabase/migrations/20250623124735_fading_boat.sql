/*
  ...
  3. Usage Tracking
    - Add `generation_type` column to track story generation type
    - Add functions to check subscription limits
*/
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Users can read own subscription data" ON user_subscriptions;
